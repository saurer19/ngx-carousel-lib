...
Run `ng generate component component-name --project ngx-carousel-lib` to generate a new component. You can also use `ng generate directive|pipe|service|class|guard|interface|enum|module --project ngx-carousel-lib`.
...
After building your library with `ng build ngx-carousel-lib`, go to the dist folder `cd dist/ngx-carousel-lib` and run `npm publish`.
